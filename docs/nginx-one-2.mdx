...
1. Click the *Stop* button below to stop the NGINX Plus 3 instance, which will mark it offline in the console.
    ...
    > **Note:** If the instance above shows a green **Run** button, you will need to refresh the lab guide page.
...
Time to clean up the remaining resources you created in this lab. As a safety precaution, the NGINX One console will not allow you to delete an instance that is online. We will first have to shut down the instances before deleting them from the NGINX One console.
