...
1. Go back to NGINX ONE console, open the configuration view of the instance and examine the file **api_gateway.conf**. Upon understanding, test some endpoints with curl commands:
 ```
 # SSL Termination
