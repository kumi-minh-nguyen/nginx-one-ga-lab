...
1. Form the API request
    ...
    - Open the body of chosen API request, add the **license** part ***(line 28-33)*** at the same level as **nginxone** part like this:
    ![postman-jwt-license](media/part5-04.png)
    >:warning: **Warning**: do not forget the `,` after the `}` at line 27 before adding **license** part.
