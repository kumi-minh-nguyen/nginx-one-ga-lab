...
1. Input values for DAPI API request
    ...
    - On the right hand side, choose **Variables** tab, provide values for some fields in the **Current value** column
        ...
        - **ncg_port**: 443
        - **nginx_license_token** : If you're running NGINX R33, this is the NGINX JWT license token. Use the below JWT for this lab:
...
1. Form the API request
    ...
    ```
    - After the above modification, the **license** part should be at the same level as **nginxone** part like this:
